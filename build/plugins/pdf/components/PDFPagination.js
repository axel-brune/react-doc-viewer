...
var PDFPagination = function () {
    ...
    return (react_1.default.createElement(Container, { id: "pdf-pagination" },
        react_1.default.createElement(PageNavButtonLeft, { id: "pdf-pagination-prev", onClick: function () { return dispatch(actions_1.setCurrentPage(currentPage - 1)); }, disabled: currentPage === 1, type: 'button' },
        ...
        react_1.default.createElement(PageTag, { id: "pdf-pagination-info" },
            ...
            "/",
            numPages),
        react_1.default.createElement(PageNavButtonRight, { id: "pdf-pagination-next", onClick: function () { return dispatch(actions_1.setCurrentPage(currentPage + 1)); }, disabled: currentPage >= numPages, type: 'button' },
